...
class CadastroHorariosFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        datePicker.init(
            ...
            exibirHorariosDisponiveis(year, month, dayOfMonth)
        }

        // Definindo o clique para o botão de salvar
    ...
    private fun verificarUsuarioFuncionario() {
            ...
            db.collection("profissionais")
                ...
                .addOnSuccessListener { document ->
                    if (document.exists()) {
                        ...
                        btSalvarHorarios.isEnabled = true
                        horariosLayout.visibility = View.VISIBLE
                    } else {

                        btSalvarHorarios.isEnabled = false
                        horariosLayout.visibility = View.GONE
                        Toast.makeText(requireContext(), "Acesso restrito apenas para funcionários!", Toast.LENGTH_SHORT).show()
                    }
                }
                .addOnFailureListener { e ->

                    Toast.makeText(requireContext(), "Erro ao verificar usuário: $e", Toast.LENGTH_SHORT).show()
                }
        }
    }


    private fun exibirHorariosDisponiveis(year: Int, month: Int, dayOfMonth: Int) {
    ...
    private fun salvarHorarios() {
        ...
        if (horariosSelecionados.isNotEmpty()) {
            ...
            if (userId != null) {
                ...
                val horariosRef = db.collection("funcionarios")
                    .document(userId)
                    .collection("agenda")
