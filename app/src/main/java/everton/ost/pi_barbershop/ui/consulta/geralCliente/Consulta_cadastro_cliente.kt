...
class ConsultaCadastroClienteFragment : Fragment() {
    ...
    private lateinit var consultaCliente: consultaCliente
    private lateinit var editaCliente: EditaCliente
    private lateinit var excluirCliente: ExcluirCliente
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_consulta_cadastro_cliente, container, false)
        ...
        consultaCliente = consultaCliente(requireContext())
        editaCliente = EditaCliente(requireContext())
        excluirCliente = ExcluirCliente(requireContext())


        consultaCliente.fetchUserData(
            profileImageView,
            editTextNome,
            editTextCpf,
            editTextEmail,
        ...
        btnExcluir.setOnClickListener {
            ...
            excluirCliente.deleteUser(view)
        }
